...
public class Utils {
    ...
    public static final String PIZZA_2_TITLE = "BBQ chicken pizza";
    ...
    public static final String PIZZA_3_TITLE = "Cajun prawn pizza";
    ...
    public static final String PIZZA_4_TITLE = "Chicken tikka masala pizzas";
    ...
    public static final String PIZZA_5_TITLE = "Rainbow pizzas";
    ...
    public static final String PIZZA_6_TITLE = "Pork, gorgonzola & garlic butter pizza";
    ...
    public static final String PIZZA_7_TITLE = "Spinach & blue cheese pizza";
    ...
    public static final String PIZZA_8_TITLE = "Pizza Margherita in 4 easy steps";
    ...
    public static final String PIZZA_9_TITLE = "Spelt pizza bianco with Jersey Royals";
    ...
    public static final String PIZZA_10_TITLE = "Frying pan pizza with aubergine, ricotta & mint";
